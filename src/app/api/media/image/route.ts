...
function generateFallbackSvgDataUrl(ctx: { protocol?: string; apy?: number; action?: string }): string {
  ...
  <defs><radialGradient id="g" cx="50%" cy="40%" r="60%">
    <stop offset="0%" stop-color="#C8FF3D" stop-opacity="0.55"/><stop offset="60%" stop-color="#C8FF3D" stop-opacity="0"/>
  </radialGradient></defs>
  <rect width="1024" height="576" fill="#F4F1EA"/><rect width="1024" height="576" fill="url(#g)"/>
  ...
  <circle cx="900" cy="80" r="6" fill="#C8FF3D"/><circle cx="930" cy="80" r="6" fill="#C8FF3D" opacity="0.6"/><circle cx="960" cy="80" r="6" fill="#C8FF3D" opacity="0.3"/>
</svg>`;
